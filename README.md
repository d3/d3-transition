...
The progress is a value between 0(begin) to 1(end). You can set the progress of the transition at any time, Note: the value is negative if get the progress on the runtime status.
